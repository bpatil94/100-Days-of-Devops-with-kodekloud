...
## Step 1 — Identify the server in which the apache service is failing.( check for all 3 app servers) (H2)
...
```
## Step 2 - Verify why the service is failing and apply the fix.(H2)
